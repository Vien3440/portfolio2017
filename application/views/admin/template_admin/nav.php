  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-link"></i> <span>Gestion contacte</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>Gestion Skills</span></a></li>
        
        
        <!--        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Gestion Expérience</span>
